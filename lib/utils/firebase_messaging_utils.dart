...
void handleNotificationClick(RemoteMessage message) {
  if (message.data != null) {
    if (message.data.containsKey('is_chat')) {
      ...
      print('tesat id cc' + ' type ' + message.data["type"]);
      print((message.data["type"] == 'update_user_subscription_order_status' &&
                  notId.isNotEmpty)
              .toString() +
          ' test validation notification');
      if (message.data["type"] == 'update_user_subscription_order_status' &&
          notId.isNotEmpty) {
      ...
      if (message.data["type"] == 'update_user_subscription_order_status' &&
        ...
        navigatorKey.currentState!.push(MaterialPageRoute(
            builder: (context) =>
                ServiceDetailScreen(serviceId: notId.toInt())));
      }
    }
  }
}

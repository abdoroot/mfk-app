...
import 'package:booking_system_flutter/screens/service/myHome_screen.dart';
                    ...
                    return SettingSection(
                      ...
                      items: [
                        ...
                        SettingItemWidget(
                          ...
                          title: language.myHome,
                          trailing: trailing,
                          onTap: () {
                            doIfLoggedIn(context, () {
                              MyHomeScreen().launch(context);
                            });
                          },
                        ),
                        SettingItemWidget(
                          leading: ic_order.iconImage(size: SETTING_ICON_SIZE),
                        ...
                        SettingItemWidget(
                          leading: ic_plan.iconImage(size: SETTING_ICON_SIZE),
                          title: language.myPlan,
                          trailing: trailing,
                          onTap: () {
                            doIfLoggedIn(context, () {
                              PlansScreen(

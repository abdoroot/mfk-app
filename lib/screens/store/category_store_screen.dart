...
import 'package:booking_system_flutter/screens/store/view_all_product_store.dart';
...
class _StoreCategoryScreenState extends State<StoreCategoryScreen> {
  ...
  void init() async {
    future = getStoreCategoryListWithPagination(page,
        categoryList: categoryList, lastPageCallBack: (val) {
      isLastPage = val;
    });
    if (page == 1) {
      key = UniqueKey();
